...
- **Cultivation Assistant / IPM Technician**
  - Perform scheduled scouting and trap checks.
  - Document pest and disease findings.
  - Prepare and apply approved IPM treatments.
- **Head Grower / Cultivation Lead**
  - Define approved products and rotation schedules.
...
- Hand lens (10–30×) or digital microscope
...
2. Look for:
   - **Insects:** thrips, aphids, fungus gnats, mites, whiteflies
   - **Damage:** stippling, leaf curl, necrotic spots, webbing
...
|---------------|------------------|
| Fungus gnats  | ≥5 per trap per week |
| Thrips        | ≥2 adults per trap or visible larvae |
| Aphids        | Any live colony |
| Spider mites  | Any confirmed presence |
...
#### 9.1 Preparation
1. Review IPM log and confirm treatment need.
