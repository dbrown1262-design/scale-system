...
def PrintOneLabel(Strain, LabelType, HarvestDate, MetrcId, Weight):
...
#PrintOneLabel("Chocolate Dipped Bananas","Trimmed Flower","2024-06-15","1A4120200001DE2000000001",15000)
